/* global owaspPasswordStrengthTest, TextEncoder */
(function () {
  'use strict'
  ...
  PasswordValidator.prototype.bindEvents = function () {
    ...
    this.form.addEventListener('submit', this.validateFormSubmission.bind(this))
  }
  ...
  /**
   * Validate the form before the submission
   */
  PasswordValidator.prototype.validateFormSubmission = function () {
    console.log('todo implement validateFormSubmission')
  }
  ...
  PasswordValidator.prototype.getFeedbackFromLevel = function () {
    switch (this.currentStrengthLevel) {
      case 0:
      case 1:
        return this.FEEDBACK_ERROR
      case 2:
        return this.FEEDBACK_WARNING
      case 3:
      case 4:
  ...
  PasswordValidator.prototype.getStrengthLevelProgressClass = function () {
    switch (this.currentStrengthLevel) {
      case 0:
        return this.STRENGTH_PROGRESS_0
      case 1:
        return this.STRENGTH_PROGRESS_1
      case 2:
        return this.STRENGTH_PROGRESS_2
      case 3:
        return this.STRENGTH_PROGRESS_3
      case 4:
        return this.STRENGTH_PROGRESS_4
    }
  }
  ...
  PasswordValidator.prototype.getFeedbackIconClass = function (feedback) {
    switch (feedback) {
      case this.FEEDBACK_SUCCESS:
        return this.ICON_SUCCESS
      case this.FEEDBACK_WARNING:
        return this.ICON_WARNING
      case this.FEEDBACK_ERROR:
  ...
  PasswordValidator.prototype.getValidationClass = function (feedback) {
    switch (feedback) {
      ...
      case this.FEEDBACK_WARNING:
        return this.VALIDATION_WARNING
      case this.FEEDBACK_ERROR:
  ...
  PasswordValidator.prototype.sha1 = function (str) {
    ...
    //  TODO: check crypto availability in IE
